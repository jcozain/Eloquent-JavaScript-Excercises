...
// This construct acts as a way both to define new variables and to 
// give existing ones a new value.
...
// already exist in the inner scope. If the variable is not defined at all, 
// throw a ReferenceError (which is another standard error type).
...
specialForms["set"] = function(args, env) {
    if(args.length != 2 || args[0].type != 'word'){
        throw new SyntaxError('Error: bad use of set function');
    }
    ...
    throw new ReferenceError('No such variable \''+varName+'\' exists');
};
